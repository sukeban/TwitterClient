...
public class MentionsFragment extends TweetsListFragment implements RequestListener {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
	    ...
	    getMentions(this, true);
	}
	
	public void getMore() {
		getMentions(this, false);
	}

	public void getMentions(final RequestListener listener, final boolean clear) {
